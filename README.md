# AwesomeApp
---
This is practice converting PSD to HTML and CSS, using SASS and Webpack
...
## How to Use
---
Open in your favorite code editor folder **AwesomeApp** and start editing files in `src` folder.
